...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_hoist_non_react_statics__ = __webpack_require__(19);
...
var BrowserTag = function () {
  ...
  BrowserTag.prototype.addComponent = function addComponent(componentId) {
    ...
    if (undefined !== 'production' && this.components[componentId]) {
...
var ThemeProvider = function (_Component) {
  ...
  ThemeProvider.prototype.getTheme = function getTheme(passedTheme) {
    ...
    if (isFunction(theme)) {
      ...
      if (undefined !== 'production' && !__WEBPACK_IMPORTED_MODULE_0_is_plain_object___default()(mergedTheme)) {
...
var _constructWithOptions = (function (css) {
  var constructWithOptions = function constructWithOptions(componentConstructor, tag) {
    ...
    if (undefined !== 'production' && typeof tag !== 'string' && typeof tag !== 'function') {
...
var _Rate = __webpack_require__(20);
